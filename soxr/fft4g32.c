...
static void cft1st(int n, float *a, float const *w);
...
static void bitrv2(int n, int *ip0, float *a)
{
...
static void bitrv2conj(int n, int *ip0, float *a)
{
...
static void forward (int length, void * setup, float * H) {_soxr_safe_rdft_f(length,  1, H); (void)setup;}
static void backward(int length, void * setup, float * H) {_soxr_safe_rdft_f(length, -1, H); (void)setup;}
